[![Build Status](https://github.com/opspec-pkgs/k8s.config.apply/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/k8s.config.apply/actions?query=workflow%3Abuild+branch%3Amain)
